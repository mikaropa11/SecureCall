...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideAuthenticationRepository(firebaseAuth: FirebaseAuth, firebaseFirestore: FirebaseFirestore):
            AuthenticationRepository = AuthenticationRepositoryImpl(firebaseAuth, firebaseFirestore)
